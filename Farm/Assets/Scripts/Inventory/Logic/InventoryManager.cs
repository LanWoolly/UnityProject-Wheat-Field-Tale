...
namespace Farm.Inventory
{
    public class InventoryManager : Singleton<InventoryManager>, ISaveable
    {
        ...
        {
            currentBoxBag = boxBag_SO;
        }

        private void OnBuildFurnitureEvent(int ID, Vector3 mousePos)
        {
            RemoveItem(ID, 1);
            BluePrintDetails bluePrint = bluePrintData.GetBluePrintDetalis(ID);
        ...
        /// <returns>-1 则没有这个物品否则返回序号</returns>
        ...
        /// <param name="isSellTrade">买或卖</param>
        ...
        {
            var bluePrintDetails = bluePrintData.GetBluePrintDetalis(ID);
